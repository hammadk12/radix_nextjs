  ...
  return (
    <div className='p-font p-10 mb-[280px] mt-[120px] md:mb-[260px] m-10 md:mx-20 lg:mb-[240px] lg:mx-[400px] lg:mt-[80px]'>
        <div className='text-left m-auto'>
            <p className='text-4xl md:text-5xl lg:text-6xl lg:leading-[80px] font-semibold mb-[-2px] '><span className='text-white'>Evolve</span> your workouts. Make progress. <span className='text-white'>Reap</span> the rewards.</p>
            ...
            <Flex justify="left">
              <Link href='/start'>
              <Button variant='solid' className='mr-6 px-12 py-6 rounded-md font-extrabold text-white mb-8 cursor-pointer'>Get Started</Button>
              </Link>
              <Button 
                variant='solid' 

...
const InfoSection = () => {
  return (
    <div className='mx-10 md:mx-20 lg:mx-[200px] rounded-3xl text-[#e3defffe] outline mb-[200px] md:p-4'>
      <Grid
        className='grid md:grid-flow-row w-full text-center md:gap-x-36 p-12 lg:gap-y-20'
        columns={{ sm: '1fr', md: '1fr 1fr' }}
        rows="1fr 1fr 1fr"
      >
        <div className=''>
          <h2 className='text-3xl lg:text-5xl'>Everything in <span className='font-extrabold text-[#FFFFFF] underline'>one</span> place.</h2>
        ...
        <div className='md:flex justify-center items-center  mb-20'>
          <h3>Choose your experience level, your goal, and tell us what you like. It’s as simple as that.</h3>
        </div>
        <div className=''>
          <h2 className='text-3xl lg:text-5xl'>Get started in <span className='font-extrabold text-[#FFFFFF] underline'>minutes</span>.</h2>
          <Select.Root defaultValue='Select' size="2">
          <p>Choose goal: </p>
            <Select.Trigger color='purple' variant='solid' className='bg-[#e3defffe]'/>
            <Select.Content color='purple' variant='soft' position='popper' highContrast>
        ...
        <div className='md:flex justify-center items-center  mb-20'>
          <h3>After HTrain processes your goals, you’ll receive a custom plan just for you.</h3>
        </div>
        <div className=''>
          <h2 className='text-3xl lg:text-5xl'><span className='font-extrabold text-[#FFFFFF] underline'>Reach</span> your goals.</h2>
        ...
        <div className='md:flex justify-center items-center '>
          <h3>Track your progress, reach your goals, and achieve what you always wanted.</h3>
        </div>
      </Grid>
      </div>
  )
